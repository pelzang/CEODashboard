...
function Sidebar({ activeSection, onSelect }) {
  return <aside className="sidebar">
    ...
    <div className="sidebar-bottom"><div className="data-status"><span></span><div><strong>Systems operational</strong><p>Last synced 9:24 AM</p></div></div><div className="profile"><div className="avatar">LD</div><div><strong>Leki Dendup</strong><span>Chief Executive Officer</span></div><Icon name="more" size={18}/></div></div>
  </aside>
}
